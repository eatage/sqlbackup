...
    public class FtpWeb
    {
        string ftpServerIP, ftpRemotePath, ftpUserID, ftpPassword, ftpURI;
 
        /// <summary>
        /// 连接FTP (IP 目录 ID Passwd)
        /// </summary>
...
        }
        ...
        public bool Connect()
        {
            ...
            try
            {
                ...
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri("ftp://" + ftpServerIP + "/" + ftpRemotePath + "/"));
...
            catch (Exception ex)
            {
                Insert_Standard_ErrorLog.Insert("Delete Error --> " + ex.Message + "  文件名:" + fileName);
            }
        }
 
        /// <summary>
