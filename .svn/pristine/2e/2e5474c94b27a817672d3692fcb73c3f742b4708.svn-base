...
namespace sqlbackup 
{
    class INIFile
    {
        ...
        /// <param name="val">值</param>
        /// <returns></returns>
        public static  long SetINIString(string section,string key, string val)
        {
        ...
        /// <returns></returns>
        public static List<string> ReadKeyValues(string section)
        {
            byte[] buffer = new byte[32767];
            List<string> list = new List<string>();
            int length = GetPrivateProfileSection(section, buffer, buffer.GetUpperBound(0), strFilePath);
            string temp;
            int postion = 0;
